 ...
 *
 * @package RenameMe
 * @since RenameMe 1.1.0
 */

if ( ! class_exists( 'Renameme_Protocol_Relative_Theme_Assets' ) ) :
	class Renameme_Protocol_Relative_Theme_Assets {
		/**
	...
	$renameme_protocol_relative_theme_assets = new Renameme_Protocol_Relative_Theme_Assets;
endif;
